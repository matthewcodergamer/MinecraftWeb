const RUNTIME_BUILD_ID='0.15.1';
const SOURCE_PARTS = [
  '00-engine-core.js','10-studio-v6.js','20-studio-v7.js','30-studio-v8.js','40-studio-v9.js','50-studio-v10.js','60-studio-v11.js','70-studio-v12.js','80-studio-v13.js','81-v13-1-hotfix.js','82-v13-1-1-responsive-title.js','83-v13-2-antialiasing.js','90-v14-frustum-culling.js','91-v14-1-bedrock-behavior.js','92-v14-2-bedrock-audio.js','93-v14-3-physics-entity-world-polish.js','94a-v14-4-java-data-assets.js','94b-v14-4-java-combat-hud.js','94c-v14-4-java-ui-runtime.js','95a-v14-5-java-assets-render.js','95b-v14-5-java-ui.js','95c-v14-5-java-audio.js','95d-v14-5-java-celestials.js','95e-v14-5-java-passive-ai.js','95f-v14-5-java-collision-combat.js','95g-v14-5-java-icon-hotfix.js','96a-v14-6-render-sections.js','96b-v14-6-scheduling-entities.js','96c-v14-6-performance-governor.js','97a-v14-7-render-ui.js','97b-v14-7-items-audio.js','97c-v14-7-animation-collision.js','97d-v14-7-fidelity-hotfix.js','98-v14-8-photon-resource-packs.js','98b-v14-8-java-title-resourcepack-hotfix.js','98c-v14-8c-java-ui-assets-fix.js','98d-v14-8c3-java-ui-stability.js','98e-v15-java-ui-overhaul.js','98f-v15-java-world-pause-ui.js','98g-v15-1-photon-1-3b-port.js','99-finalize.js'
];
(function installBootVisualsV151(){
 const old=document.getElementById('mcBootVisualsV151');if(old)old.remove();
 const style=document.createElement('style');style.id='mcBootVisualsV151';style.textContent=`
 #loading.v15Loading{background-image:linear-gradient(rgba(22,18,15,.62),rgba(22,18,15,.72)),url('https://raw.githubusercontent.com/PrismarineJS/minecraft-assets/master/data/1.21.8/gui/title/background/panorama_0.png')!important;background-size:cover!important;background-position:center!important;background-repeat:no-repeat!important;image-rendering:auto!important;backdrop-filter:blur(1.5px);-webkit-backdrop-filter:blur(1.5px)}
 #loading.v15Loading::before{content:'';position:absolute;inset:0;background:radial-gradient(circle at center,transparent 0 42%,rgba(0,0,0,.28) 100%);pointer-events:none}
 #loadingBar{position:relative!important;z-index:2!important;width:min(640px,74vw)!important;height:18px!important;padding:3px!important;background:#111!important;border:2px solid #8a8a8a!important;box-shadow:inset 1px 1px #000,inset -1px -1px #d0d0d0,0 2px 5px #0008!important;border-radius:0!important;overflow:hidden!important}
 #loadingFill{height:100%!important;background:linear-gradient(#8fcf55 0 18%,#66ad3b 18% 82%,#4b842d 82% 100%)!important;box-shadow:inset 1px 0 #a7e56b,inset -1px 0 #3d6d25!important;transition:width .12s linear!important}
...
async function bootMinecraftFromParts(){
 ...
 try{
  ...
  let done=0;
  const parts=await Promise.all(SOURCE_PARTS.map(async(name)=>{const text=await fetchPart(name);done++;if(loadingText)loadingText.textContent=`Initializing Java UI • Photon • World Engine • Assets ${done}/${SOURCE_PARTS.length}`;if(loadingFill)loadingFill.style.width=`${Math.round(done/SOURCE_PARTS.length*92)}%`;return text;}));
  if(loadingText)loadingText.textContent='Starting Minecraft Web V15.1…';if(loadingFill)loadingFill.style.width='96%';
  const source=`${parts.join('\n\n')}\n//# sourceURL=minecraft-v15-1-photon-runtime.js`;const blob=new Blob([source],{type:'text/javascript'}),url=URL.createObjectURL(blob);
 ...
 }catch(error){console.error('[V15.1 BOOT]',error);if(loadingText)loadingText.textContent=`Engine failed: ${error.message}`;loading?.classList?.add('show');}
}
