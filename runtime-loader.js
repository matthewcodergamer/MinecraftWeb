...
(function installBootVisualsV1592(){
  ...
  style.textContent=`
    @font-face{font-family:'Minecraft Seven';src:url('./assets/fonts/Minecraft-Seven.woff?v=0.16.0') format('woff'),url('https://raw.githubusercontent.com/Mojang/web-theme-bootstrap/main/assets/fonts/Minecraft-Seven_v2.woff') format('woff');font-style:normal;font-weight:400;font-display:swap}
...
function showBootFailure(error){
  ...
  console.error('[V16.0 BOOT]',error);
...
async function importSourceFallback(){
  ...
  await nextPaint();
  const source=`${parts.join('\n\n')}\n//# sourceURL=minecraft-v16-0-source-fallback.js`;
...
async function bootMinecraft(){
  ...
  try{
    try{
      ...
      console.warn('[V16.0 BOOT] cached bundle unavailable; using bounded source fallback.',error);
